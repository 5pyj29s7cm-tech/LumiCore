...
function buildLegalDocumentContract(): LumiActionContract {
  return withDefaults({
    ...
    verificationTools: ['legal_case_reasoning_matrix', 'legal_generate_citation_verification_report', 'legal_finalize_delivery_package', 'legal_search_statute', 'read_docx', 'read_pdf', 'desktop_path_info', 'work_product_verify'],
