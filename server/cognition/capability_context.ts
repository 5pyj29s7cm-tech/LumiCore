...
export function buildLumiRuntimeCapabilityContext(input: LumiRuntimeCapabilityContextInput): string {
  ...
  return [
    ...
    'Per-turn tool exposure follows task intent, authorization and explicit no-tool boundaries. It is not an installation inventory. Lumi has no selectable operation modes; background work follows independent workflow policy.',
