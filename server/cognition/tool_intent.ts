...
const TOOL_INTENT_PATTERNS: RegExp[] = [
  ...
  /(?:\u770b\u76d8|\u76ef\u76d8|\u884c\u60c5|\u80a1\u7968|\u7f8e\u80a1|\u6e2f\u80a1|\u7092\u80a1|\u8d22\u7ecf\u65b0\u95fb|\u6a21\u62df\u76d8|\u4ea4\u6613\u8ba1\u5212|\u628a.*\u6280\u80fd.*(?:\u88c5\u4e0a|\u5b89\u88c5)|(?:\u88c5\u4e0a|\u88c5\u4e00\u4e0b).*\u6280\u80fd)/u,
  /(?:\u628a|\u5c06)?.*(?:\u6587\u4ef6|\u6587\u6863|\u8d44\u6599).*(?:\u8bfb|\u8bfb\u53d6|\u770b\u4e00\u4e0b|\u6253\u5f00)/u,
  /(?:\u628a|\u5c06)?.*(?:\u6587\u4ef6|\u6587\u6863|\u8d44\u6599|\u8fd9\u4efd|\u8fd9\u4e2a).*(?:\u603b\u7ed3|\u6458\u8981|\u5f52\u7eb3|\u63d0\u70bc|\u5206\u6790)/u,
  /(?:(?:\u5e2e\u6211|\u5e2e|\u7ed9|\u628a)?.*(?:\u56de\u4e00\u4e0b|\u56de\u590d|\u56de|\u8349\u7a3f).*(?:\u5fae\u4fe1|\u4f01\u4e1a\u5fae\u4fe1|\u98de\u4e66|\u6d88\u606f|\u5ba2\u6237)|(?:\u5fae\u4fe1|\u4f01\u4e1a\u5fae\u4fe1|\u98de\u4e66|\u6d88\u606f|\u5ba2\u6237).*(?:\u56de\u590d|\u56de\u4e00\u4e0b|\u56de|\u8349\u7a3f))/u,
  /(?:\u7ee7\u7eed|\u63a5\u7740|\u5f80\u4e0b).*(?:\u4efb\u52a1|\u5ba2\u6237|\u4ea4\u4ed8|\u63a5\u7ba1|\u5de5\u4f5c|\u9879\u76ee)/u,
  /(?:\u521b\u5efa|\u65b0\u5efa|\u751f\u6210|\u5bfc\u51fa|\u4fdd\u5b58|\u5199\u5165|\u7f16\u8f91|\u4fee\u6539|\u5220\u9664|\u6574\u7406|\u5206\u6790|\u5236\u4f5c|\u505a|\u753b|\u51fa).*(?:\u6587\u4ef6|\u6587\u4ef6\u5939|\u76ee\u5f55|\u6587\u6863|\u62a5\u544a|\u6c47\u62a5|\u8868\u683c|PPT|ppt|\u5e7b\u706f\u7247|\u4ee3\u7801|\u9879\u76ee|\u5e94\u7528|\u7a0b\u5e8f|\u7f51\u9875|\u7f51\u7ad9|\u94fe\u63a5|\u8fd0\u884c\u65e5\u5fd7|\u65e5\u5fd7|\u5de5\u4f5c\u6d41|\u811a\u672c|\u7ec8\u7aef|\u547d\u4ee4|\u4ed3\u5e93|github|\u6570\u636e\u5e93|\u77e5\u8bc6\u5e93|\u6a21\u677f|\u7ec4\u7ec7|\u8bbe\u7f6e|\u8bbe\u5907|\u5c4f\u5e55|cad|CAD|\u56fe\u7eb8|\u8349\u7a3f\u56fe|\u5e73\u9762\u56fe|\u65bd\u5de5\u56fe|\u8bbe\u8ba1\u56fe)/iu,
...
const CLIENT_ACTION_INTENT_PATTERNS: RegExp[] = [
  ...
  /(?:\u5207\u6362|\u5207\u5230|\u6362\u5230|\u8fdb\u5165|\u6253\u5f00|\u5f00\u542f|\u542f\u52a8|\u5f00\u59cb).*(?:\u804a\u5929|\u52a9\u624b|\u4f1a\u8bae|\u97f3\u4e50|\u81ea\u52a8\u6267\u884c|\u81ea\u4e3b\u6267\u884c|\u4f1a\u8bae\u6a21\u5f0f|\u97f3\u4e50\u6a21\u5f0f|\u52a9\u624b\u6a21\u5f0f|\u804a\u5929\u6a21\u5f0f|\u6c1b\u56f4\u5c42|\u97f3\u4e50\u4e2d\u5fc3|\u77e5\u8bc6\u5e93|\u8fd0\u884c\u65e5\u5fd7|\u65e5\u5fd7|\u8bbe\u7f6e|\u58c1\u7eb8\u6a21\u5f0f|\u7ec4\u7ec7|\u4e91\u7aef|\u6587\u4ef6|\u6280\u80fd|\u5de5\u5177|\u5f62\u8c61|\u58f0\u97f3|\u8bbe\u5907|\u540c\u6b65|\u5185\u6838|\u76d1\u63a7|\u8ba1\u5212|\u56e2\u961f)/u,
...
const CLIENT_ACTION_ONLY_PATTERNS: RegExp[] = [
  ...
  /\b(play|put\s+on|listen\s+to)\b.*\b(music|song|playlist|album)\b/i,
  /(?:\u5207\u6362|\u5207\u5230|\u6362\u5230|\u8fdb\u5165|\u6253\u5f00|\u5f00\u542f|\u542f\u52a8|\u5f00\u59cb).*(?:\u804a\u5929|\u52a9\u624b|\u4f1a\u8bae|\u97f3\u4e50|\u81ea\u52a8\u6267\u884c|\u81ea\u4e3b\u6267\u884c|\u4f1a\u8bae\u6a21\u5f0f|\u97f3\u4e50\u6a21\u5f0f|\u52a9\u624b\u6a21\u5f0f|\u804a\u5929\u6a21\u5f0f|\u6c1b\u56f4\u5c42|\u97f3\u4e50\u4e2d\u5fc3|\u77e5\u8bc6\u5e93|\u8fd0\u884c\u65e5\u5fd7|\u65e5\u5fd7|\u8bbe\u7f6e|\u58c1\u7eb8\u6a21\u5f0f|\u7ec4\u7ec7|\u4e91\u7aef|\u6280\u80fd|\u5de5\u5177|\u5f62\u8c61|\u58f0\u97f3|\u8bbe\u5907|\u540c\u6b65|\u5185\u6838|\u76d1\u63a7|\u8ba1\u5212|\u56e2\u961f|\u6587\u4ef6\u7ba1\u7406\u5668|\u6587\u4ef6\u4e2d\u5fc3)/u,
  /(?:\u653e|\u64ad\u653e|\u542c).*(?:\u97f3\u4e50|\u6b4c|\u6b4c\u66f2|\u6b4c\u5355|\u4e13\u8f91)/u,
];
...
function isRationaleOnlyQuestion(text: string): boolean {
  return /^(?:why\b|\u4e3a\u4ec0\u4e48|\u4e3a\u5565|\u4e3a\u4f55)/iu.test(text)
...
export function hasExplicitToolIntent(text: string): boolean {
  ...
  if (isRationaleOnlyQuestion(normalized)) return false;
