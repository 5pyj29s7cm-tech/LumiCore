...
const CAPABILITY_RULES: CapabilityRule[] = [
  ...
  },
  {
    ...
    label: 'CAD/BIM 交付物',
    kind: 'external_app',
    tools: ['work_takeover_task_prepare_industry_package', 'floorplan_extract_geometry', 'cad_generate_dxf', 'cad_prepare_autocad_operations', 'mcp_cad-drafting_autocad_playback_file', 'desktop_open', 'work_product_verify'],
