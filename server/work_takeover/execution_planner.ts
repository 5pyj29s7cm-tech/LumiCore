...
const CAPABILITY_RULES: CapabilityRule[] = [
  ...
  },
  {
    ...
    label: '文档/方案/报价材料',
    kind: 'document',
    tools: ['create_docx', 'create_xlsx', 'create_pdf', 'work_takeover_task_prepare_industry_package', 'work_product_verify'],
  ...
  },
  {
    ...
    label: 'CAD/BIM 交付物',
    kind: 'external_app',
    tools: ['work_takeover_task_prepare_industry_package', 'floorplan_extract_geometry', 'cad_generate_dxf', 'cad_generate_autocad_draw_script', 'mcp_cad-drafting_autocad_playback_file', 'cad_run_autocad_draw_script', 'desktop_open', 'desktop_run_command', 'work_product_verify'],
  ...
  },
  {
    ...
    label: '视频内容生成与发布准备',
    kind: 'automation',
    tools: ['work_takeover_task_prepare_industry_package', 'short_video_script', 'content_topic_pipeline', 'content_calendar_builder', 'create_docx', 'browser_open_task'],
