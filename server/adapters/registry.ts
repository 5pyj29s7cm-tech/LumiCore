...
export function getAdapterRegistry(options: AdapterRegistryOptions = {}): AdapterRegistryReport {
  ...
  const adapters: AdapterCapability[] = [
    ...
    },
    {
      ...
      notes: 'Use for research, authenticated pages, and handoff to browser tasks. Prefer existing logged-in browser profiles or windows before asking for a new login; for new authorized sites use web_login_learn_site or web_login_profile_save. Stop at QR/OTP/CAPTCHA/authorization boundaries.',
    },
    {
