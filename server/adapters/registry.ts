...
export function getAdapterRegistry(options: AdapterRegistryOptions = {}): AdapterRegistryReport {
  ...
  const adapters: AdapterCapability[] = [
    ...
    },
    {
      ...
      category: 'messaging',
      status: 'draft_only',
      actions: ['wechat_intake_analyze', 'wechat_intake_from_clipboard', 'wechat_prepare_reply', 'wechat_copy_reply_draft'],
      ...
      safety: 'Lumi can read user-provided or copied message text, triage it into work takeover, draft replies, and copy drafts. Sending or external posting must stay user-confirmed.',
