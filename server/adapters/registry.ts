...
export function getAdapterRegistry(options: AdapterRegistryOptions = {}): AdapterRegistryReport {
  ...
  const adapters: AdapterCapability[] = [
    ...
    },
    {
      ...
      category: 'client',
      status: !hasState ? 'requires_setup' : staleState ? 'attention' : 'ready',
      actions: ['self_intro_demo', 'client_action', 'desktop_show_lumi_window', 'desktop_set_wallpaper_mode', 'desktop_open', 'desktop_clipboard_write'],
    ...
    },
    {
      ...
      surfaces: ['work takeover task pool', 'WeChat intake', 'result panels', 'external app handoff'],
      ...
      notes: 'Persistent task hub for customer, store, account, case-filing, video-publishing, and design-delivery takeover work. Use it so Lumi can resume a task after the user says continue.',
    },
    {
    ...
    },
    {
      ...
      actions: ['computer_use', 'desktop_open', 'desktop_clipboard_write', 'desktop_cursor_glow_show', 'desktop_cursor_glow_update', 'desktop_cursor_glow_click', 'desktop_active_window', 'desktop_capture_screen'],
      ...
      notes: 'This is Lumi using the computer, not the default route for Lumi client UI. For external desktop work, inspect screen/active window, show and move the cursor before clicks, explain task intent, and report blockers.',
    },
    {
      id: 'web.browser',
    ...
    },
    {
      ...
      notes: 'Current workflow can generate Dynamo/Revit handoff files for reviewed modeling. Native RVT production output still needs a confirmed adapter or Revit automation environment.',
    },
    {
