...
export function getAdapterRegistry(options: AdapterRegistryOptions = {}): AdapterRegistryReport {
  ...
  const adapters: AdapterCapability[] = [
    ...
    },
    {
      ...
      category: 'cad_bim',
      status: 'ready',
      actions: ['floorplan_extract_geometry', 'ocr_image_file', 'cad_generate_dxf', 'cad_generate_autocad_draw_script', 'mcp_cad-drafting_autocad_playback_file', 'cad_run_autocad_draw_script', 'design_delivery_workflow', 'mcp_cad-drafting_cad_renovation_folder_workflow'],
    ...
    },
    {
      ...
      actions: ['mcp_cad-drafting_cad_renovation_folder_workflow', 'cad_generate_dxf', 'cad_generate_autocad_draw_script', 'mcp_cad-drafting_autocad_playback_file', 'cad_run_autocad_draw_script', 'floorplan_extract_geometry', 'desktop_open', 'external_app_list_adapters', 'computer_use'],
