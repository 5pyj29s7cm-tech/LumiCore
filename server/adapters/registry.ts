...
export function getAdapterRegistry(options: AdapterRegistryOptions = {}): AdapterRegistryReport {
  ...
  const adapters: AdapterCapability[] = [
    ...
    },
    {
      ...
      actions: ['computer_use', 'desktop_open', 'desktop_run_command', 'desktop_clipboard_write', 'desktop_cursor_glow_show', 'desktop_cursor_glow_update', 'desktop_cursor_glow_click', 'desktop_mouse_click_at', 'desktop_active_window', 'desktop_ui_snapshot', 'desktop_ui_focus', 'desktop_ui_click', 'desktop_ui_invoke', 'desktop_ui_type', 'desktop_capture_screen'],
    ...
    },
    {
      ...
      category: 'cad_bim',
      status: 'draft_only',
      actions: ['floorplan_extract_geometry', 'ocr_image_file', 'cad_generate_dxf', 'cad_generate_autocad_draw_script', 'design_delivery_workflow', 'mcp_cad-drafting_cad_renovation_folder_workflow'],
    ...
    },
    {
      ...
      actions: ['mcp_cad-drafting_cad_renovation_folder_workflow', 'cad_generate_dxf', 'cad_generate_autocad_draw_script', 'floorplan_extract_geometry', 'desktop_open', 'external_app_list_adapters', 'computer_use'],
