...
const CLIENT_CAPABILITIES: ClientCapability[] = [
  ...
  },
  {
    ...
    notes: 'Same practical permissions as Assistant, plus 24h continuous/background operation, proactive questions, monitoring, memory absorption, public-source web learning, sorting, task checkpoints, and ultra-long continuation.',
...
export function formatClientSelfPrompt(userId: string): string {
  ...
  return [
    ...
    'When Lumi is alone in Autonomy mode, she can create bounded public-source learning refreshes with web_search, url_fetch, and authority_research. She must cite URLs, retrieval time, confidence, and uncertainty, and treat login-required, paid, captcha, QR/OTP, private, or account-authorization pages as blockers. Long-term knowledge writes still need explicit authorization unless a confirmed workflow explicitly grants that write.',
