...
const CLIENT_CAPABILITIES: ClientCapability[] = [
  ...
  },
  {
    ...
    kind: 'external_app',
    actions: ['floorplan_extract_geometry', 'ocr_image_file', 'cad_generate_dxf', 'cad_generate_autocad_draw_script', 'mcp_cad-drafting_autocad_playback_file', 'cad_run_autocad_draw_script', 'design_delivery_workflow', 'desktop_list_apps', 'desktop_open', 'desktop_run_command'],
