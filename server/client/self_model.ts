...
const CLIENT_CAPABILITIES: ClientCapability[] = [
  ...
  },
  {
    ...
    kind: 'system',
    actions: ['design_delivery_workflow', 'design_delivery_panel', 'close_design_delivery_panel', 'desktop_show_lumi_window', 'desktop_set_wallpaper_mode', 'desktop_open', 'desktop_clipboard_write', 'cad_generate_dxf'],
    notes: 'In this stage, when the user asks Lumi to take over a renovation/design delivery task, Lumi can generate a local proposal package, budget/material list, CAD DXF and SVG preview, Revit/Dynamo handoff files, and a WeChat delivery draft. Production drawings still require confirmed site dimensions, structure, utilities, and user sign-off.',
    requiresConfirmation: true,
    stateKeys: ['surfaces', 'windows', 'voice', 'tools', 'permissions'],
  },
  {
