  ...
  try {
    ...
    const messages = [
      { role: 'system' as const, content: [
        ...
        'For autonomous web learning, you may use public web_search, url_fetch, and authority_research. Treat them as observation: cite URLs, retrieval time, confidence, and uncertainty. Do not use login-required, paid, captcha, QR/OTP, private, or account-authorization pages as completed sources. Do not call authority_research_save or other long-term knowledge writes unless the task itself contains explicit user authorization; otherwise produce source-grounded knowledge candidates for later absorption.',
      ].join('\n\n') },
