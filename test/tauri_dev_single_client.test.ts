...
const debugExe = 'D:\\lumiOS\\src-tauri\\target\\debug\\lumi-os.exe';
...
describe('tauri dev stale client cleanup', () => {
  ...
  it('collects stale debug client process trees without unrelated processes', () => {
    const processes = [
      { ProcessId: 10, ParentProcessId: 1, Name: 'lumi-os.exe', ExecutablePath: debugExe },
      ...
      { ProcessId: 20, ParentProcessId: 1, Name: 'lumi-os.exe', ExecutablePath: 'C:\\Program Files\\LumiOS\\lumi-os.exe' },
