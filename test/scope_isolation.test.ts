  ...
  it('separates capability category from personal and organization ownership', () => {
    ...
    const createRecord = (scopeDomain: 'personal' | 'work', orgId: string) => upsertCapabilityLearningRecord({
      ...
      selectedRoute: {
        ...
        label: 'AutoCAD script route',
        interfacePattern: 'script_bridge',
        preferredTools: ['cad_generate_autocad_draw_script'],
        fallbackTools: [],
        avoid: [],
      ...
      existingTools: ['cad_generate_autocad_draw_script'],
      nextUse: {
        triggerHints: ['AutoCAD'],
        preferredTools: ['cad_generate_autocad_draw_script'],
        firstStep: 'cad_generate_autocad_draw_script',
