...
export const validMemoryAvatar = (value: any): boolean => object(value)
...
export const memoryAvatarService = {
  ...
  update: (id: string, input: PatchMemoryAvatarInput, signal?: AbortSignal) => request<MemoryAvatar>(idPath(id), 'PATCH', input, signal, validAvatar),
