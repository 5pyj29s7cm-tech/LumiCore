...
export function OrgPortal({
  ...
  if (!user) {
    return (
      <div data-organization-wallpaper-gateway className="lumi-org-gateway lumi-work-surface flex items-center justify-center p-20">
  ...
  if (isConnected && (workDomain !== 'work' || !hasActiveOrgSession)) {
    return (
      <div data-organization-wallpaper-gateway className="lumi-org-gateway lumi-work-surface flex items-center justify-center p-8 h-full">
  ...
  return (
    <div data-organization-wallpaper-gateway className="lumi-org-gateway lumi-work-surface p-8">
